{$IFDEF D2DOCKER}library{$ELSE}program{$ENDIF} Tabulator;
...
uses
  ...
  TabulatorWebApp in 'TabulatorWebApp.pas' {TabulatorWebAppGlobal},
  Tabulator_Session in 'Tabulator_Session.pas' {TabulatorSession},
