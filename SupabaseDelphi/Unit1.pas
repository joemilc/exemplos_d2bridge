...
uses
  ...
  Vcl.Menus, D2Bridge.Forms, Unit2; //Declare D2Bridge.Forms always in the last unit
...
type
  TForm1 = class(TD2BridgeForm)
    ...
    procedure AppModule21Click(Sender: TObject);
  private
...
procedure TForm1.AppModule21Click(Sender: TObject);
begin
  if Form2 = nil then
