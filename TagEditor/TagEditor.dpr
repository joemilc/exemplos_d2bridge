{$IFDEF D2DOCKER}library{$ELSE}program{$ENDIF} TagEditor;
...
uses
  ...
  TagEditorWebApp in 'TagEditorWebApp.pas' {TagEditorWebAppGlobal},
  TagEditor_Session in 'TagEditor_Session.pas' {TagEditorSession},
